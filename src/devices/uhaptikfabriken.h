...
// -----------------------------------------------------------------------------
// Bluetooth Socket Proxy (below was in SocketClient.h before)
// -----------------------------------------------------------------------------
#ifdef  USE_BT_SOCKET
        ...
        if (listenSocket != INVALID_SOCKET) {
            ...
            if (res >= 0) {
                ...
                while (!stopClient && connected) {
                    ...
                    timeout.tv_sec = 2;
                    timeout.tv_usec = 0;
                    int activity = select(int(listenSocket) + 1, &set, NULL, NULL, &timeout);		// Any activity on socket?
